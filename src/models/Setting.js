...
const settingSchema = new mongoose.Schema(
  {
    ...
    businessName: { type: String, default: 'Tripod Wellness' },
    siteName: { type: String, default: '' },
    tagline: { type: String, default: "Premier Men's Massage & Wellness Sanctuary" },
    phone: { type: String, default: '+91-9171606807' },
    whatsapp: { type: String, default: '+91-9171606807' },
    ...
    smtpSenderName: { type: String, default: 'Tripod Wellness Concierge' },
